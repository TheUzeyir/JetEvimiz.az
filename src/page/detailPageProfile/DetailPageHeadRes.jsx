  ...
  return (
    <div className={style.detailPage_main_head_right_resBox}>
      <div className={style.detailPage_main_head_right_head}>
        <button className={style.detailPage_main_head_right_head_btn_edit}>
          Düzəliş et
        </button>
        <button
          className={style.detailPage_main_head_right_head_btn_delete}
        ...
        <div className={style.detailPage_main_bottom_left_box}>
          <p className={style.detailPage_main_bottom_left_box_title_humanCard}>
            <div className={style.detailPage_main_bottom_left_box_title_humanCard_head}>
              <span
                className={
                  style.detailPage_main_bottom_left_box_title_humanCard_head_humanText
                }
              >
              ...
              {product.parameters[1] && (
                <span
                  className={
                    style.detailPage_main_bottom_left_box_title_humanCard_head_cityText
                  }
                >
            ...
            <IoIosPerson
              className={
                style.detailPage_main_bottom_left_box_title_humanCard_icon
              }
            />
          </p>
          <div
            className={
              style.detailPage_main_bottom_left_box_title_humanCard_nummBox
            }
      ...
      <div className={style.detailPage_main_bottom_right_card}>
        {likedProducts.some(
          ...
          >
            <BsFillHeartFill
              className={
                style.detailPage_main_bottom_right_card_title_icon
              }
            />{" "}
            Bəyənilənlərdən sil
          </p>
        ...
        >
          <FaFlag
            className={
              style.detailPage_main_bottom_right_card_subtitle_icon
            }
          />{" "}
          Şikayət et
        </p>
